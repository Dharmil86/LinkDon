    ...
    <UserLayout>
        <DashboardLayout>
          ...
          <div className={styles.backDropContainer}>
                ...
                }} hidden type="file" id='profilePictureUpload' accept='image/*'/>
                ...
                <div className={styles.activitySection}>
                    ...
                    return(
                        ...
                        <div className={styles.card}>
                            ...
                            {post.media  ? <img className={styles.backDrop}src={`${BASE_URL}/uploads/${post.media}`} alt=''/> : <div style={{width: "3.4rem", height: "3.4rem"}}></div>}
                            </div>
                        </div>
                        </div>
                    )
